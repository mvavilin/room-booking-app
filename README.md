...
Для поддержания актуального состояния приложения между несколькими открытыми вкладками браузера реализована событийная синхронизация через встроенный браузерный API **BroadcastChannel**.
...
Вкладка B        Вкладка C
   │                │
Получение события   Получение события
   │                │
   ↓                ↓
